...
print(f"}};")
print(f"")
print(f"static Line PROSPERO_LINES[{len(line)}] = {{")
...
print(f"}};")
print(f"")
print(f"static Oval PROSPERO_OVALS[{len(oval)}] = {{")
...
print(f"}};")
print(f"")
print(f"static Shapes PROSPERO_SHAPES = {{")
print(f"  .lines = PROSPERO_LINES,")
print(f"  .ovals = PROSPERO_OVALS,")
print(f"}};")
